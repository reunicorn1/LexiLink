        ...
        <Box display="flex" alignItems="center" bg="#606161" justifyContent="center">
            <Box  h="100%" color="white"  >
                <Box pl="100px" pt="50px" pb="50px" maxW="1250px">
                    <Heading  mb={4} >Join Our Community</Heading>
                    <Text w={{base:"70%", '2xl':"80%"}}>Are you passionate about English language learning? Are you an experienced English tutor looking to make a meaningful impact? Join our vibrant community of learners and mentors on LexiLink.</Text>
                    <Link to='/mentor'>
